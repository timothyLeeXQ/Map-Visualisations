...
```{r}
kml_road <- read_file("lta-road-camera/LTA_Road_Enforcement_Camera.kml")
```
...
markdown::rpubsUpload(title = "Mata Cams",
                      htmlFile = "mata_cams_widget.html",
                      id = "https://api.rpubs.com/api/v1/document/618858/71401a2b8d4448daab63e757e092594e")
